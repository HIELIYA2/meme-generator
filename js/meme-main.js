...
function render() {
    ...
    if (!txts.length && currTxt.txt !== '') {
        ...
        console.log(`gtxt is empty, currtxt is full`)
        ...
        console.log(`gtxt full, currtxt is empty`)
        ...
        console.log(`gtxt full, currtxt is full`)
...
function toggleMenu() {
    ...
    gOpen = !gOpen;
    if (gOpen) {
        elButtonMenu.innerHTML = `<i class="fas fa-times"></i>`;
    } else {
        elButtonMenu.innerHTML = `<i class="fas fa-bars"></i>`;
    }
}
